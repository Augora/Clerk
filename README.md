...
* Deputes (577 items)
  * Depute
    ...
    * Sites web (1547 items)
      * Site (e.g. <https://twitter.com/CedricRoussel06>)
    * Emails (788 items)
      * Email (e.g. 6circo03@en-marche.fr)
    * Adresses (941 items)
      * Adresse (e.g. Assemblée nationale, 126 Rue de l'Université, 75355 Paris 07 SP)
    * Collaborateurs (2114 items)
      * Collaborateur (e.g. M. Yassine Id-Nasser Medjani)
...
* Deputes (565 items)
  * Depute
    ...
    * Amendements signes (e.g. 4900)
    * Amendements adoptes (e.g. 107)
    * Rapports (e.g. 1)
    * Propositions ecrites (e.g. 4)
    * Propositions signees (e.g. 156)
    * Questions ecrites (e.g. 49)
